      ...
      return (
        <>
            ...
            <div>
              ...
              <div className="level1">
                <span
                  ...
                  className={
                    this.state.difficulty === "Easy" ? "active level" : "level"
                  }
                >
                  Easy
                </span>
                ...
                <span
                  onClick={(e) => this.handleDifficulty(e)}
                  className={
                    this.state.difficulty === "Hard" ? "active level" : "level"
                  }
                >
                  Hard
                </span>
              ...
              {categories.map((c) => {
                return (
                  <div
                    key={c.id}
                    className={
                      this.state.category === c.name ? "cat active" : "cat"
                    }
                  >
                    <h4 onClick={(e) => this.handleCategory(e)} id={c.id}>
                      {c.name}
                    </h4>
                  </div>
                );
          ...
          {this.state.category && this.state.difficulty ? (
            <div className="start" onClick={this.handleSubmit}>
              <button>Start</button>
            </div>
          ) : (
            <></>
