...
class Quiz extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://opentdb.com/api.php?amount=10&category=${categoryId}&difficulty=${difficulty.toLowerCase()}`
    )
      .then((data) => data.json())
      .then((data) =>
        this.setState({
    ...
    if (this.state.QuesNo > 10) {
      return (
        <Result
          ...
          allQues={this.state.quesAndAns.results}
        />
      );
    } else {
          ...
          <section>
            ...
            <div className="container">
              <div className="progress">
                <span className="first-ques">
                  Question {this.state.QuesNo}/10
                </span>
              ...
              <ul className="ques">
                {allQues[order].correct_answer ? (
                  <div>
                    {" "}
                    <li
                      onClick={(e) => this.handleAnswer(e)}
                      className={
                        this.state.clickedAns.answers.includes(
                          allQues[order].correct_answer
                        )
                          ? "clickedAns"
                          : ""
                ...
                {allQues[order].incorrect_answers[0] ? (
                  <div>
                    {" "}
                    <li
                      onClick={(e) => this.handleAnswer(e)}
                ...
                {allQues[order].incorrect_answers[1] ? (
                  <div>
                    {" "}
                    <li
                      onClick={(e) => this.handleAnswer(e)}
                ...
                {allQues[order].incorrect_answers[2] ? (
                  <div>
                    {" "}
                    <li
                      onClick={(e) => this.handleAnswer(e)}
